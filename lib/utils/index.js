...
function mergeConfigs(branch, striderJson) {
  ...
  // In those objects we find keys which are the IDs of the plugin and the value is the default configuration of that
  // plugin.
  // We recursively traverse this data structure and merge it into a single hash, so we can access the
  // configurations for each extension easily.
