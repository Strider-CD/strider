...
var init = exports.init = function (config) {
  ...
  app.get('/projects', auth.requireUser, routes.projects);
  ...
  app.del('/:org/:repo/cache/:branch', auth.requireUser, middleware.project, auth.requireProjectAdmin, api_repo.clear_cache);
  ...
  app.post('/:org/:repo/keygen/:branch', auth.requireUser, middleware.project, auth.requireProjectAdmin, api.config.keygen);
