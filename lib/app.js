...
var init = exports.init = function (config) {
  ...
  app.get('/projects', auth.requireUser, function(req, res) { res.render('projects.html'); });
  ...
  app.get('/:org/:repo/badge', middleware.project, routes_jobs.badge);
  ...
  app.put('/:org/:repo/config/:branch/', auth.requireUser, middleware.project, auth.requireProjectAdmin, routes.setPluginOrder)
  ...
  */
  ...
  // app.del('/:org/:repo/', middleware.project, auth.requireProjectAdmin, routes.delete_project);
...
var run = exports.run = function(app){
  ...
  websockets.init(server, session_store);
  backchannel.init();
