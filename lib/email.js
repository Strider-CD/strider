...
var send_password_reset_html = renderJade(
            path.join(__dirname, '../views', 'email_templates', 'html','send_password_reset.jade'));

var send_password_reset_plaintext = renderJade(
            path.join(__dirname, '../views', 'email_templates', 'plaintext','send_password_reset.jade'));
...
exports.send_password_reset = function (user) {
  ...
  var subject = "[STRIDER] - Password Reset - " +
                current_time.getHours() +
                ":" + current_time.getMinutes();
  var body_text = send_password_reset_plaintext(template_options);
  var body_html = send_password_reset_html(template_options);
  var to = user.email;
