...
function deprecated(env) {
  ...
  if (env.APP_SECRET) {
    ...
    console.warn("This name has been deprecated. Please use STRIDER__GITHUB_APP_SECRET instead.\n")
  ...
  if (env.GITHUB_APP_ID) {
    ...
    console.warn("This name has been deprecated. Please use STRIDER__GITHUB_APP_ID instead.\n")
  ...
  if (env.GITHUB_API_ENDPOINT) {
    console.warn("WARNING: You are using GITHUB_API_ENDPOINT to configure Github api base.")
    console.warn("This name has been deprecated. Please use STRIDER__GITHUB_API_BASE instead.\n")
