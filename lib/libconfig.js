...
var envDefaults = {
  ...
  jobsQuantityOnPage: {
    enabled: process.env.JOBSQUANTITYONPAGE_ENABLED || true,
    default: process.env.JOBSQUANTITYONPAGE_DEFAULT || 20,
    min: process.env.JOBSQUANTITYONPAGE_MIN || 1,
    max: process.env.JOBSQUANTITYONPAGE_MAX || 100
  }
};
