$(function(){
  ...
  // right now there is nothing at the job level but leaving here as a placeholder
  // this is prob where we should be building the custom URLs and whatnot to pass to the view
